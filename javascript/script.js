...
function obtenerReservasServidor() {
    fetch('https://65bb-2806-261-a401-55f-7c88-ee9f-9e2c-9538.ngrok-free.app/reservas')
...
function eliminarReserva(id) {
    fetch(`https://65bb-2806-261-a401-55f-7c88-ee9f-9e2c-9538.ngrok-free.app/reservas/${id}`, {
        method: 'DELETE',
    })
    .then(response => {
        if (!response.ok) {
